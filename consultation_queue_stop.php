                                ...
                                <div class="box-body">
                                    <div class="col-md-6">
                                        ...
                                        <div id="patient_details" class="form-group">
 										<?php 
										if ($user_gender == 'F') { 
											$sql= "select p.patient_id,p.name,p.gender,p.age,p.mobile_no,p.reg_date,v.visit_id from patient p,visit v where p.gender='F' and v.visit_date =  '$current_date' and v.c_start_time is null and p.patient_id=v.patient_id and v.visit_id not in(select visit_id from consultation) order by v.visit_id desc;";
											} else {
