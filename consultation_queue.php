                                ...
                                <div class="box-body">
                                    <div class="col-md-6">
                                        ...
                                        <div id="patient_details" class="form-group">
 										<?php 
										if ($user_gender == 'F') { 
											$sql1= "select p.patient_id,p.name,p.gender,p.age,p.mobile_no,p.reg_date,v.visit_id from patient p,visit v where p.gender='F' and v.visit_date =  '$current_date' and v.c_start_time is not null and v.visit_end_time is null and p.patient_id=v.patient_id and v.skip_consultation = 0 and  order by v.visit_id desc;";
											} else {
											$sql1= "select p.patient_id,p.name,p.gender,p.age,p.mobile_no,p.reg_date,v.visit_id from patient p,visit v where v.visit_date =  '$current_date' and v.c_start_time is not null and v.visit_end_time is null and p.patient_id=v.patient_id and v.skip_consultation = 0 order by v.visit_id desc;";	
												} // end of else
